...
export const CalendarContextProvider = ({ children }: PropsWithChildren) => {
    ...
    // Single-date provider; cast to the context value type to satisfy react-aria's
    // onChange union (which also allows date arrays for range/multi calendars).
    const contextValue = { value, onChange, focusedValue, onFocusChange } as ContextType<typeof AriaCalendarContext>;
